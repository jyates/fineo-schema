 ...
 */
public abstract class UpdateMetricHandler implements UpdateMetricHandler<YOUR_EVENT_TYPE> {
  ...
  public UpdateMetricHandler(Provider<FirehoseBatchWriter> archive,
