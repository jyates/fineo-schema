 ...
 */
public abstract class CreateOrgHandler implements RequestHandler<CreateOrgRequest, CreateOrgResponse>{
  ...
  public CreateOrgHandler(Provider<FirehoseBatchWriter> archive,
